...
return array(
  ...
  'language'           => 'vi', // en Default language
  'language_fallback'  => 'vi', // en Fallback language when file isn't available for default language
  'locale'             => 'vi_VN', // en_US PHP set_locale() setting, null to not set
  'locales'            => array(
  'vi' => 'vi_VN',
    'en' => 'en_US',
	 ...
	 */
	 'module_paths' => array(
      APPPATH.'modules'.DS,
      APPPATH.'..'.DS.'cms'.DS.'modules'.DS #thư mục cms/modules sẽ chứa toàn bộ modules Giang làm 
	 ),
