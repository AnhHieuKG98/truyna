...
function myCallback($cmd, $result, $args, $elfinder) {
  return create_seo_name($cmd);
}

$opts = array(
	// 'debug' => true,
  
  //Giang : convert tên ảnh sang dạng seo-name-slug
  'bind' => array(
    #'mkdir mkfile rename duplicate upload rm paste' => 'myCallback',
  ...
  //END Giang : convert tên ảnh sang dạng seo-name-slug
	...
	'roots' => array(
      ...
      'path'          => '../../../../uploads/',               // Giang set path 
			'URL'           =>  '/uploads/', // Giang set URL  dirname($_SERVER['PHP_SELF']) . '/../../../../uploads/'
      ...
      'plugin' => array(
          'Sanitizer' => array(
              ...
              'replace'  => '-',    // replace to this OK OK OK
              'callBack' => 'myCallback' // Or @callable sanitize function
          )
      ),
      //END Giang : convert tên ảnh sang dạng seo-name-slug
...
//Giang 
function create_seo_name( $object_name ){
